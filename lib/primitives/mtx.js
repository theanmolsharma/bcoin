...
class CoinSelector {
  ...
  getWaste(selected, costOfChange, target) {
    ...
    for (const i of selected) {
      ...
      waste +=
        (currentFeeRate - CoinSelector.LONG_TERM_FEERATE) * utxo.spendingSize;
    }
...
CoinSelector.MAX_MONEY = consensus.MAX_MONEY;
